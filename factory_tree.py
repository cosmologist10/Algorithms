...
import sys
import unittest
from hackerrank.tree.tree import BinaryTree
...
if __name__ == "__main__":
    mytree = TreeFactory.build_from_list([10,4,5,3])
    print mytree
    mytree.display()
    ...
    mytree1 = TreeFactory.build_tree_random(6)
    print mytree1
    mytree1.display()
    ...
    mytree2 = TreeFactory.build_tree_random(6)
    print mytree2
    mytree2.display()
